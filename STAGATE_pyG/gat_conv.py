...
class GATConv(MessagePassing):
    ...
    def __init__(self, in_channels: Union[int, Tuple[int, int]],
        ...
        self.heads = heads  # 控制是否使用多头attention
        self.concat = concat
        ...
        nn.init.xavier_normal_(self.lin_src.data, gain=1.414)   # 初始化矩阵W size=(in_channels, out_channels)
        self.lin_dst = self.lin_src


        # The learnable parameters to compute attention coefficients:
        # attention matrix -> GAT_Conv.md中的a
